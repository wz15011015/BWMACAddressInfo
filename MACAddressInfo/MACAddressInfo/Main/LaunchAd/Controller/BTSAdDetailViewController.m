...
@interface BTSAdDetailViewController () <WKNavigationDelegate>
...
@implementation BTSAdDetailViewController
...
- (void)viewDidLoad {
    ...
    // 2. 加载数据
    self.urlString = IS_NULL_STRING(self.urlString) ? @"https://www.apple.com/" : self.urlString;
